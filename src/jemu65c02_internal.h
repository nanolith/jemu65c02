...
/**
 * \brief Handle an PHY instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_PHY)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle a ROL A instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROL_a)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a ROL ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROL_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a ROL ZER instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROL_zer)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle a ROR A instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROR_a)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a ROR ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROR_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a ROR ZER instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROR_zer)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a ROR ABS X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROR_abs_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a ROR ZER X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_ROR_zer_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an SBC IMM instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_imm)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SBC ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SBC ZER instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_zer)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SBC ZER IDR instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_zer_idr)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SBC ABS X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_abs_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an SBC ZER X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_zer_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SBC ZER X IDR instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_zer_x_idr)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SBC ZER Y IDR instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SBC_zer_y_idr)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an SEC instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SEC)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an SEI instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_SEI)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an STA ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STA_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an STA ZER X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STA_zer_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an STA ZER X IDR instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STA_zer_x_idr)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an STX ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STX_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an STX ZER instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STX_zer)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an STY ZER instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STY_zer)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an STY ZER X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STY_zer_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an STZ ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STZ_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle an STZ ZER instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STZ_zer)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle an STZ ZER X instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_STZ_zer_x)(
    JEMU_SYM(j65c02)* inst, int* cycles);

/**
 * \brief Handle a TAX instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_TAX)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle a TRB ABS instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_TRB_abs)(
    JEMU_SYM(j65c02)* inst, int* cycles);
...
/**
 * \brief Handle a TXA instruction.
 *
 * \param inst              The emulator instance on which this instruction
 *                          executes.
 * \param cycles            The number of cycles taken to execute this
 ...
 *      - a non-zero error code on failure.
 */
JEMU_SYM(status) JEMU_SYM(j65c02_inst_TXA)(
    JEMU_SYM(j65c02)* inst, int* cycles);
