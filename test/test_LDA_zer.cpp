...
/**
 * 0xA5 LDA zer normal result (not negative or zero).
 */
TEST(step_LDA_zer_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, add the LDA input. */
    mem[0x0005] = EXPECTED_LDA_INPUT;
...
/**
 * 0xA5 LDA zer Zero result.
 */
TEST(step_LDA_zer_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xA5 LDA zer, the negative flag is set.
 */
TEST(step_LDA_zer_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
