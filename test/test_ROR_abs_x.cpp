...
TEST(step_ROR_abs_x)
{
    ...
    /* at 0x2005, add the expected input. */
    ...
    TEST_EXPECT(EXPECTED_OUTPUT == mem[0x2005]);
...
/**
 * 0x7E ROR ABS X carry in.
 */
TEST(step_ROR_abs_x_carry_in_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_INPUT = 0x20;
...
/**
 * 0x7E ROR ABS X non-zero result.
 */
TEST(step_ROR_abs_x_non_zero_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x7E ROR ABS X zero carry result.
 */
TEST(step_ROR_abs_x_carry_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x7E ROR ABS X negative flag.
 */
TEST(step_ROR_abs_x_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x7E ROR ABS X zero result.
 */
TEST(step_ROR_abs_x_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
