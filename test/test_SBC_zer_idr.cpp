...
/**
 * 0xF2 SBC zer idr binary subtract without carry.
 */
TEST(step_SBC_zer_idr_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xF2 SBC zer idr binary subtract with borrow input.
 */
TEST(step_SBC_zer_idr_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF2 SBC zer idr binary subtract causes borrow.
 */
TEST(step_SBC_zer_idr_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF2 SBC zer idr binary subtract causes zero flag.
 */
TEST(step_SBC_zer_idr_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF2 SBC zer idr decimal subtract without carry.
 */
TEST(step_SBC_zer_idr_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xF2 SBC zer idr decimal subtract with borrow input.
 */
TEST(step_SBC_zer_idr_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xF2 SBC zer idr decimal subtract causes borrow.
 */
TEST(step_SBC_zer_idr_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xF2 SBC zer idr decimal subtract causes zero flag.
 */
TEST(step_SBC_zer_idr_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
