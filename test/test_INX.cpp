...
/**
 * 0xE8 INX (non-zero / non-negative to non-zero / non-negative).
 */
TEST(step_INX_non_zero_non_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add an INX instruction. */
    mem[0x1000] = 0xE8;
    ...
    /* POSTCONDITION: X is 0x03. */
    TEST_EXPECT(0x03 == j65c02_reg_x_get(inst));
...
/**
 * 0xE8 INX (0x7F to 0x80).
 */
TEST(step_INX_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
