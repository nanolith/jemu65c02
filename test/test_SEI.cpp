...
/**
 * 0x78 SEI instruction.
 */
TEST(step_SEI_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a SEI instruction. */
    mem[0x1000] = 0x78;
    ...
    /* PRECONDITION: clear the interrupt disable flag. */
    ...
    /* POSTCONDITION: the interrupt disable flag is set. */
