...
/**
 * SBC binary subtract without carry.
 */
TEST(op_SBC_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    JEMU_SYM(j65c02_op_SBC)(inst, EXPECTED_SUB_INPUT);
...
/**
 * SBC binary subtract with borrow input.
 */
TEST(op_SBC_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * SBC binary subtract causes borrow.
 */
TEST(op_SBC_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * SBC binary subtract causes zero flag.
 */
TEST(op_SBC_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * SBC decimal subtract without carry.
 */
TEST(op_SBC_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * SBC decimal subtract with borrow input.
 */
TEST(op_SBC_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * SBC decimal subtract causes borrow.
 */
TEST(op_SBC_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * SBC decimal subtract causes zero flag.
 */
TEST(op_SBC_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
