...
TEST_SUITE(j65c02_CMP_zer_x_idr);
...
/**
 * 0xC1 CMP ZER X IDR (comparing two equal values).
 */
TEST(step_CMP_zer_x_idr_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xC1 CMP ZER X IDR (comparing a lesser value).
 */
TEST(step_CMP_zer_x_idr_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xC1 CMP ZER X IDR (comparing a greater value).
 */
TEST(step_CMP_zer_x_idr_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
