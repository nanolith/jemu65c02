...
/**
 * 0xE4 CPX ZER (comparing two equal values).
 */
TEST(step_CPX_zer_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, add the CPX input. */
    mem[0x0005] = EXPECTED_CPX_INPUT;
...
/**
 * 0xE4 CPX ZER (comparing a lesser value).
 */
TEST(step_CPX_zer_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE4 CPX ZER (comparing a greater value).
 */
TEST(step_CPX_zer_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
