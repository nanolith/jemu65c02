...
TEST_SUITE(j65c02_AND_zer_x_idr);
...
TEST(step_AND_zer_x_idr)
{
    ...
    /* at 0x2000, set the and input. */
    mem[0x2000] = EXPECTED_AND_INPUT;
...
/**
 * 0x21 AND ZER X IDR zero flag.
 */
TEST(step_AND_zer_x_idr_zero_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_AND_INPUT = 0x12;
...
/**
 * 0x21 AND ZER X IDR negative flag.
 */
TEST(step_AND_zer_x_idr_negative_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
