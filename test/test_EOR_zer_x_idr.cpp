...
TEST_SUITE(j65c02_EOR_zer_x_idr);
...
/**
 * 0x41 EOR zer x idr normal result (not negative or zero).
 */
TEST(step_EOR_zer_x_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x41 EOR zer x idr Zero result.
 */
TEST(step_EOR_zer_x_idr_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x41 EOR zer x idr, the negative flag is set.
 */
TEST(step_EOR_zer_x_idr_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
