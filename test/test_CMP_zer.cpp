...
/**
 * 0xC5 CMP ZER (comparing two equal values).
 */
TEST(step_CMP_zer_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, set the CMP input. */
    mem[0x0005] = EXPECTED_CMP_INPUT;
...
/**
 * 0xC5 CMP ZER (comparing a lesser value).
 */
TEST(step_CMP_zer_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xC5 CMP ZER (comparing a greater value).
 */
TEST(step_CMP_zer_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
