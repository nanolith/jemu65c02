...
/**
 * 0x30 BMI branch not taken.
 */
TEST(step_BMI_no_branch)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BMI instruction. */
    mem[0x1000] = 0x30;
    mem[0x1001] = 5;
...
/**
 * 0x30 BMI branch taken, positive jump.
 */
TEST(step_BMI_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x30 BMI branch taken, negative jump.
 */
TEST(step_BMI_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
