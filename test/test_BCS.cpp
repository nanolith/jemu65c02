...
/**
 * 0xB0 BCS branch not taken.
 */
TEST(step_BCS_no_branch)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BCS instruction. */
    mem[0x1000] = 0xB0;
    mem[0x1001] = 5;
...
/**
 * 0xB0 BCS branch taken, positive jump.
 */
TEST(step_BCS_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xB0 BCS branch taken, negative jump.
 */
TEST(step_BCS_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
