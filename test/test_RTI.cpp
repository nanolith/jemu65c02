...
TEST(step_RTI)
{
    ...
    /* at 0x1000, add an RTI instruction. */
    mem[0x1000] = 0x40;

    /* "push" the return address onto the stack. */
    mem[0x0150] = 0x20;
    mem[0x014F] = 0x00;
    mem[0x014E] = JEMU_65c02_STATUS_NC;
    ...
    /* PRECONDITION: stack pointer is 0x4D. */
    j65c02_reg_sp_set(inst, 0x4D);
