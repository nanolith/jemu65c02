...
/**
 * 0x65 ADC ZER (test without carry).
 */
TEST(step_ADC_zer_without_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at zero-page offset 5, set the add input. */
    mem[0x0005] = EXPECTED_ADD_INPUT;
...
/**
 * 0x65 ADC ZER (test with carry).
 */
TEST(step_ADC_zer_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x65 ADC ZER (test set carry).
 */
TEST(step_ADC_zer_set_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x65 ADC ZER (overflow 1)
 */
TEST(step_ADC_zer_overflow1)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x65 ADC ZER (overflow 2)
 */
TEST(step_ADC_zer_overflow2)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x65 ADC ZER (BCD no carry).
 */
TEST(step_ADC_zer_BCD)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    for (int i = 0; i <= 10; ++i)
    {
        ...
        /* at zero-page offset 5, set the add input. */
        mem[0x0005] = EXPECTED_ADD_INPUT[i];
...
/**
 * 0x69 ADC IMM (test without carry).
 */
TEST(step_ADC_imm_without_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x69 ADC IMM (test with carry).
 */
TEST(step_ADC_imm_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x69 ADC IMM (test set carry).
 */
TEST(step_ADC_imm_set_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x7F;
...
/**
 * 0x69 ADC IMM (overflow 1)
 */
TEST(step_ADC_imm_overflow1)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x50;
...
/**
 * 0x69 ADC IMM (overflow 2)
 */
TEST(step_ADC_imm_overflow2)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0xd0;
...
/**
 * 0x69 ADC IMM (BCD no carry).
 */
TEST(step_ADC_imm_BCD)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT[10] = {
    ...
    for (int i = 0; i <= 10; ++i)
    {
        ...
        /* at 0x1000, add an ADC instruction. */
        mem[0x1000] = 0x69;
        mem[0x1001] = EXPECTED_ADD_INPUT[i];
...
/**
 * 0x6D ADC ABS (test without carry).
 */
TEST(step_ADC_abs_without_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x6D ADC ABS (test with carry).
 */
TEST(step_ADC_abs_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x6D ADC ABS (test set carry).
 */
TEST(step_ADC_abs_set_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x7F;
...
/**
 * 0x6D ADC ABS (overflow 1)
 */
TEST(step_ADC_abs_overflow1)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x50;
...
/**
 * 0x6D ADC ABS (overflow 2)
 */
TEST(step_ADC_abs_overflow2)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0xd0;
...
/**
 * 0x6D ADC ABS (BCD no carry).
 */
TEST(step_ADC_abs_BCD)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT[10] = {
    ...
    for (int i = 0; i <= 10; ++i)
    {
        ...
        /* at 0x0500, set the add input. */
        mem[0x0500] = EXPECTED_ADD_INPUT[i];
...
/**
 * 0x71 ADC ZER Y IDR (test without carry).
 */
TEST(step_ADC_zer_y_idr_without_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
    ...
    /* at 0x2005, set the add input. */
    mem[0x2005] = EXPECTED_ADD_INPUT;
...
/**
 * 0x71 ADC ZER Y IDR (test with carry).
 */
TEST(step_ADC_zer_y_idr_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x71 ADC ZER Y IDR (test set carry).
 */
TEST(step_ADC_zer_y_idr_set_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x7F;
...
/**
 * 0x71 ADC ZER Y IDR (overflow 1)
 */
TEST(step_ADC_zer_y_idr_overflow1)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x50;
...
/**
 * 0x71 ADC ZER Y IDR (overflow 2)
 */
TEST(step_ADC_zer_y_idr_overflow2)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0xd0;
...
/**
 * 0x71 ADC ZER Y IDR (BCD no carry).
 */
TEST(step_ADC_zer_y_idr_BCD)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT[10] = {
    ...
    for (int i = 0; i <= 10; ++i)
    {
        ...
        /* at zero-page offset 5 and y, set the address for the input. */
        mem[0x0005] = 0x00;
        mem[0x0006] = 0x20;

        /* at 0x2005, set the add input. */
        mem[0x2005] = EXPECTED_ADD_INPUT[i];
...
/**
 * 0x72 ADC ZER IDR (test without carry).
 */
TEST(step_ADC_zer_idr_without_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
    ...
    /* at 0x05, the address for the input. */
    mem[0x05] = 0x10;
    mem[0x06] = 0x08;

    /* at 0x0810, the add input. */
    mem[0x0810] = EXPECTED_ADD_INPUT;
...
/**
 * 0x72 ADC ZER IDR (test with carry).
 */
TEST(step_ADC_zer_idr_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x72 ADC ZER IDR (test set carry).
 */
TEST(step_ADC_zer_idr_set_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x7F;
...
/**
 * 0x72 ADC ZER IDR (overflow 1)
 */
TEST(step_ADC_zer_idr_overflow1)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x50;
...
/**
 * 0x72 ADC ZER IDR (overflow 2)
 */
TEST(step_ADC_zer_idr_overflow2)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0xd0;
...
/**
 * 0x72 ADC ZER IDR (BCD no carry).
 */
TEST(step_ADC_zer_idr_BCD)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT[10] = {
    ...
    for (int i = 0; i <= 10; ++i)
    {
        ...
        /* at 0x0810, set the add input. */
        mem[0x0810] = EXPECTED_ADD_INPUT[i];
...
/**
 * 0x75 ADC ZER X (test without carry).
 */
TEST(step_ADC_zer_x_without_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
    ...
    /* at zero-page offset A, set the add input. */
    mem[0x000A] = EXPECTED_ADD_INPUT;
...
/**
 * 0x75 ADC ZER X (test with carry).
 */
TEST(step_ADC_zer_x_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x12;
...
/**
 * 0x75 ADC ZER X (test set carry).
 */
TEST(step_ADC_zer_x_set_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x7F;
...
/**
 * 0x75 ADC ZER X (overflow 1)
 */
TEST(step_ADC_zer_x_overflow1)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0x50;
...
/**
 * 0x75 ADC ZER X (overflow 2)
 */
TEST(step_ADC_zer_x_overflow2)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT = 0xd0;
...
/**
 * 0x75 ADC ZER X (BCD no carry).
 */
TEST(step_ADC_zer_x_BCD)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_ADD_INPUT[10] = {
    ...
    for (int i = 0; i <= 10; ++i)
    {
        ...
        /* at zero-page offset A, set the add input. */
        mem[0x000A] = EXPECTED_ADD_INPUT[i];
