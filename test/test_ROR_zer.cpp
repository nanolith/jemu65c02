...
TEST(step_ROR_zer)
{
    ...
    /* at 0x0005, add the expected input. */
    ...
    TEST_EXPECT(EXPECTED_OUTPUT == mem[0x0005]);
...
/**
 * 0x66 ROR ZER carry in.
 */
TEST(step_ROR_zer_carry_in_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_INPUT = 0x20;
...
/**
 * 0x66 ROR ZER non-zero result.
 */
TEST(step_ROR_zer_non_zero_with_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x66 ROR ZER zero carry result.
 */
TEST(step_ROR_zer_carry_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x66 ROR ZER negative flag.
 */
TEST(step_ROR_zer_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x66 ROR ZER zero result.
 */
TEST(step_ROR_zer_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
