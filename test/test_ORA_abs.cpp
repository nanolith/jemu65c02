...
/**
 * 0x0D ORA ABS normal (non-zero / non-negative).
 */
TEST(step_ORA_abs_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x0D ORA ABS negative.
 */
TEST(step_ORA_abs_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
