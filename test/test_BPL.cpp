...
/**
 * 0x10 BPL branch not taken.
 */
TEST(step_BPL_no_branch)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BPL instruction. */
    mem[0x1000] = 0x10;
    mem[0x1001] = 5;
...
/**
 * 0x10 BPL branch taken, positive jump.
 */
TEST(step_BPL_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x10 BPL branch taken, negative jump.
 */
TEST(step_BPL_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
