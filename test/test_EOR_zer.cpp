...
/**
 * 0x45 EOR zer normal result (not negative or zero).
 */
TEST(step_EOR_zer_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, add the EOR input. */
    mem[0x0005] = EXPECTED_EOR_INPUT;
...
/**
 * 0x45 EOR zer Zero result.
 */
TEST(step_EOR_zer_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x45 EOR zer, the negative flag is set.
 */
TEST(step_EOR_zer_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
