...
TEST(step_AND_abs_x)
{
    ...
    /* at 0x0505, set the and input. */
    mem[0x0505] = EXPECTED_AND_INPUT;
...
/**
 * 0x3D AND ABS X zero flag.
 */
TEST(step_AND_abs_x_zero_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_AND_INPUT = 0x12;
...
/**
 * 0x3D AND ABS X negative flag.
 */
TEST(step_AND_abs_x_negative_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
