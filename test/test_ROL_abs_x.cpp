...
/**
 * 0x3E ROL ABS X carry in.
 */
TEST(step_ROL_abs_x_carry_in)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_INPUT = 0x20;
...
/**
 * 0x3E ROL ABS X non-zero carry result.
 */
TEST(step_ROL_abs_x_carry_non_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x3E ROL ABS X zero carry result.
 */
TEST(step_ROL_abs_x_carry_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x3E ROL ABS X negative flag.
 */
TEST(step_ROL_abs_x_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x3E ROL ABS X zero result.
 */
TEST(step_ROL_abs_x_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
