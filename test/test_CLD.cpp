...
/**
 * 0xD8 CLD instruction.
 */
TEST(step_CLD_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a CLD instruction. */
    mem[0x1000] = 0xD8;
    ...
    /* PRECONDITION: set the decimal flag. */
    ...
    /* POSTCONDITION: the decimal flag is clear. */
    TEST_EXPECT(!(j65c02_reg_status_get(inst) & JEMU_65c02_STATUS_DECIMAL));
