...
TEST(step_AND_zer_x)
{
    ...
    /* at zero-page offset A, set the and input. */
    mem[0x000A] = EXPECTED_AND_INPUT;
...
/**
 * 0x35 ADC ZER X zero flag.
 */
TEST(step_AND_zer_x_zero_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_AND_INPUT = 0x12;
...
/**
 * 0x35 ADC ZER X negative flag.
 */
TEST(step_AND_zer_x_negative_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
