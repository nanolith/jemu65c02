...
/**
 * 0xA9 LDA imm normal result (not negative or zero).
 */
TEST(step_LDA_imm_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xA9 LDA imm Zero result.
 */
TEST(step_LDA_imm_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xA9 LDA imm, the negative flag is set.
 */
TEST(step_LDA_imm_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
