...
/**
 * 0x09 ORA IMM normal (non-zero / non-negative).
 */
TEST(step_ORA_imm_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x09 ORA IMM negative.
 */
TEST(step_ORA_imm_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
