...
/**
 * 0xB2 LDA zer idr normal result (not negative or zero).
 */
TEST(step_LDA_zer_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xB2 LDA zer idr Zero result.
 */
TEST(step_LDA_zer_idr_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xB2 LDA zer idr, the negative flag is set.
 */
TEST(step_LDA_zer_idr_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
