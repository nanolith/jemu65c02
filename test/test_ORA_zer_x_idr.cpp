...
TEST_SUITE(j65c02_ORA_zer_x_idr);
...
/**
 * 0x01 ORA ZER X IDR normal (non-zero / non-negative).
 */
TEST(step_ORA_zer_x_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x00A, set the location for the input. */
    mem[0x000A] = 0x00;
    mem[0x000B] = 0x20;

    /* at 0x2000, add the input. */
    mem[0x2000] = EXPECTED_ORA_INPUT;
...
/**
 * 0x01 ORA ZER X IDR zero.
 */
TEST(step_ORA_zer_x_idr_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x01 ORA ZER X IDR negative.
 */
TEST(step_ORA_zer_x_idr_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
