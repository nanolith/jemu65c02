...
/**
 * 0x59 EOR abs y normal result (not negative or zero).
 */
...
/**
 * 0x59 EOR abs y Zero result.
 */
TEST(step_EOR_abs_y_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x59 EOR abs y, the negative flag is set.
 */
TEST(step_EOR_abs_y_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
