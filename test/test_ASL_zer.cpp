...
/**
 * 0x06 ASL ZER sets the carry bit if the high bit is shifted out.
 */
TEST(step_ASL_zer_carry_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x06 ASL ZER sets the negative bit if the high bit is set after shifting.
 */
TEST(step_ASL_zer_negative_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x06 ASL ZER sets the zero flag if the result is zero.
 */
TEST(step_ASL_zer_zero_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
