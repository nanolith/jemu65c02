...
/**
 * 0xDE DEC abs x (non-zero / non-negative to non-zero / non-negative).
 */
TEST(step_DEC_abs_x_non_zero_non_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x2005, add our value to decrement. */
    mem[0x2005] = 0x02;
    ...
    /* POSTCONDITION: mem[0x2005] is 0x01. */
    TEST_EXPECT(0x01 == mem[0x2005]);
...
/**
 * 0xDE DEC abs x (0x01 to zero).
 */
TEST(step_DEC_abs_x_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x2005, add the value to decrement. */
    mem[0x2005] = 0x01;
    ...
    /* POSTCONDITION: mem[0x2005] is 0x00. */
    TEST_EXPECT(0x00 == mem[0x2005]);
...
/**
 * 0xDE DEC abs x (0x00 to 0xFF).
 */
TEST(step_DEC_abs_x_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* POSTCONDITION: mem[0x2005] is 0xFF. */
    TEST_EXPECT(0xFF == mem[0x2005]);
