...
/**
 * 0x64 STZ zer instruction.
 */
TEST(step_STZ_zer_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, set the value to non-zero. */
    mem[0x0005] = 0xFF;
    ...
    /* POSTCONDITION: 0 is stored in mem[0x0005]. */
    TEST_EXPECT(0 == mem[0x0005]);
