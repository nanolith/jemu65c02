...
/**
 * 0x12 ORA ZER IDR normal (non-zero / non-negative).
 */
TEST(step_ORA_zer_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x005, set the location for the input. */
    mem[0x0005] = 0x00;
    mem[0x0006] = 0x20;
...
/**
 * 0x12 ORA ZER IDR zero.
 */
TEST(step_ORA_zer_idr_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x12 ORA ZER IDR negative.
 */
TEST(step_ORA_zer_idr_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
