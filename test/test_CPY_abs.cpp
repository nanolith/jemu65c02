...
/**
 * 0xCC CPY ABS (comparing two equal values).
 */
TEST(step_CPY_abs_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_CPY_INPUT = 0x05;
    const uint8_t EXPECTED_Y_VALUE = 0x05;
    ...
    /* at 0x1000, add a CPY instruction. */
    mem[0x1000] = 0xCC;
    mem[0x1001] = 0x00;
    mem[0x1002] = 0x20;

    /* at 0x2000, add the CPY input. */
    mem[0x2000] = EXPECTED_CPY_INPUT;
    ...
    /* PRECONDITION: set the Y register. */
...
/**
 * 0xCC CPY ABS (comparing a lesser value).
 */
TEST(step_CPY_abs_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_CPY_INPUT = 0x01;
    const uint8_t EXPECTED_Y_VALUE = 0x05;
...
/**
 * 0xCC CPY ABS (comparing a greater value).
 */
TEST(step_CPY_abs_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_CPY_INPUT = 0x10;
    const uint8_t EXPECTED_Y_VALUE = 0x05;
