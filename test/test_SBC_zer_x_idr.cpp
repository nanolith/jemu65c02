...
TEST_SUITE(j65c02_SBC_zer_x_idr);
...
/**
 * 0xE1 SBC zer x idr binary subtract without carry.
 */
TEST(step_SBC_zer_x_idr_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x000A, add the location. */
    mem[0x000A] = 0x00;
    mem[0x000B] = 0x20;

    /* at 0x2000, add the input. */
    mem[0x2000] = EXPECTED_SUB_INPUT;
...
/**
 * 0xE1 SBC zer x idr binary subtract with borrow input.
 */
TEST(step_SBC_zer_x_idr_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE1 SBC zer x idr binary subtract causes borrow.
 */
TEST(step_SBC_zer_x_idr_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE1 SBC zer x idr binary subtract causes zero flag.
 */
TEST(step_SBC_zer_x_idr_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE1 SBC zer x idr decimal subtract without carry.
 */
TEST(step_SBC_zer_x_idr_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE1 SBC zer x idr decimal subtract with borrow input.
 */
TEST(step_SBC_zer_x_idr_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xE1 SBC zer x idr decimal subtract causes borrow.
 */
TEST(step_SBC_zer_x_idr_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xE1 SBC zer x idr decimal subtract causes zero flag.
 */
TEST(step_SBC_zer_x_idr_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
