...
/**
 * 0xF8 SED instruction.
 */
TEST(step_SED_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a SED instruction. */
    mem[0x1000] = 0xF8;
    ...
    /* PRECONDITION: clear the decimal flag. */
    ...
    /* POSTCONDITION: the decimal flag is set. */
