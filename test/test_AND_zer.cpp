...
TEST(step_ADC_zer)
{
    ...
    /* at zero-page offset 5, set the and input. */
    mem[0x0005] = EXPECTED_AND_INPUT;
...
/**
 * 0x25 AND ZER zero flag.
 */
TEST(step_ADC_zer_zero_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_AND_INPUT = 0x12;
...
/**
 * 0x25 AND ZER negative flag.
 */
TEST(step_ADC_zer_negative_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
