...
/**
 * 0xC8 INY (non-zero / non-negative to non-zero / non-negative).
 */
TEST(step_INY_non_zero_non_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add an INY instruction. */
    mem[0x1000] = 0xC8;
    ...
    /* POSTCONDITION: Y is 0x03. */
    TEST_EXPECT(0x03 == j65c02_reg_y_get(inst));
...
TEST(step_INY_zero)
{
    ...
    /* POSTCONDITION: Y is 0x00. */
    TEST_EXPECT(0x00 == j65c02_reg_y_get(inst));
...
/**
 * 0xC8 INY (0x7F to 0x80).
 */
TEST(step_INY_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* POSTCONDITION: Y is 0x80 */
    TEST_EXPECT(0x80 == j65c02_reg_y_get(inst));
