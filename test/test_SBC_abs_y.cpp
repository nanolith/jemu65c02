...
/**
 * 0xF9 SBC abs y binary subtract without carry.
 */
TEST(step_SBC_abs_y_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xF9 SBC abs y binary subtract with borrow input.
 */
TEST(step_SBC_abs_y_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF9 SBC abs y binary subtract causes borrow.
 */
TEST(step_SBC_abs_y_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF9 SBC abs y binary subtract causes zero flag.
 */
TEST(step_SBC_abs_y_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF9 SBC abs y decimal subtract without carry.
 */
TEST(step_SBC_abs_y_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xF9 SBC abs y decimal subtract with borrow input.
 */
TEST(step_SBC_abs_y_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xF9 SBC abs y decimal subtract causes borrow.
 */
TEST(step_SBC_abs_y_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xF9 SBC abs y decimal subtract causes zero flag.
 */
TEST(step_SBC_abs_y_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
