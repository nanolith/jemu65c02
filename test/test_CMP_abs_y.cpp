...
/**
 * 0xD9 CMP ABS Y (comparing two equal values).
 */
TEST(step_CMP_abs_y_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x2005, set the CMP input. */
    mem[0x2005] = EXPECTED_CMP_INPUT;
...
/**
 * 0xD9 CMP ABS Y (comparing a lesser value).
 */
TEST(step_CMP_abs_y_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xD9 CMP ABS Y (comparing a greater value).
 */
TEST(step_CMP_abs_y_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
