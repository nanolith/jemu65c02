...
TEST(step_BIT_zer_x_zero)
{
    ...
    /* at 0x1000, add a BIT zer x instruction. */
    mem[0x1000] = 0x34;
    mem[0x1001] = 0x05;

    /* at 0x000A, set the value. */
    mem[0x000A] = 0x20;
...
/**
 * 0x34 BIT zer x not zero.
 */
TEST(step_BIT_zer_x_not_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_A = 0x10;
...
/**
 * 0x34 BIT zer x negative.
 */
TEST(step_BIT_zer_x_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_A = 0x10;
...
/**
 * 0x34 BIT zer x overflow.
 */
TEST(step_BIT_zer_x_overflow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_A = 0x10;
