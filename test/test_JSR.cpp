...
TEST(step_JSR)
{
    ...
    /* at 0x1000, add a JSR instruction. */
    mem[0x1000] = 0x20;
    mem[0x1001] = 0x00;
    mem[0x1002] = 0x20;
    ...
    /* POSTCONDITION: SP is 0x48. */
    TEST_EXPECT(0x4E == j65c02_reg_sp_get(inst));

    /* POSTCONDITION: the old program counter value is stored on the stack. */
    TEST_EXPECT(0x02 == mem[0x0150]);
    TEST_EXPECT(0x10 == mem[0x014F]);
