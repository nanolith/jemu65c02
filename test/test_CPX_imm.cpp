...
/**
 * 0xE0 CPX IMM (comparing two equal values).
 */
TEST(step_CPX_imm_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE0 CPX IMM (comparing a lesser value).
 */
TEST(step_CPX_imm_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE0 CPX IMM (comparing a greater value).
 */
TEST(step_CPX_imm_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
