...
TEST(step_BIT_zer_zero)
{
    ...
    /* at 0x1000, add a BIT zer instruction. */
    mem[0x1000] = 0x24;
    mem[0x1001] = 0x05;

    /* at 0x0005, set the value. */
    mem[0x0005] = 0x20;
...
/**
 * 0x24 BIT zer not zero.
 */
TEST(step_BIT_zer_not_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_A = 0x10;
...
/**
 * 0x24 BIT zer negative.
 */
TEST(step_BIT_zer_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_A = 0x10;
...
/**
 * 0x24 BIT zer overflow.
 */
TEST(step_BIT_zer_overflow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_A = 0x10;
