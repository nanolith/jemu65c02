...
/**
 * 0xE9 SBC imm binary subtract without carry.
 */
TEST(step_SBC_imm_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE9 SBC imm binary subtract with borrow input.
 */
TEST(step_SBC_imm_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE9 SBC imm binary subtract causes borrow.
 */
TEST(step_SBC_imm_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE9 SBC imm binary subtract causes zero flag.
 */
TEST(step_SBC_imm_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE9 SBC imm decimal subtract without carry.
 */
TEST(step_SBC_imm_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE9 SBC imm decimal subtract with borrow input.
 */
TEST(step_SBC_imm_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xE9 SBC imm decimal subtract causes borrow.
 */
TEST(step_SBC_imm_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xE9 SBC imm decimal subtract causes zero flag.
 */
TEST(step_SBC_imm_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
