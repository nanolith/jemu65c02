...
/**
 * 0xDD CMP ABS X (comparing two equal values).
 */
TEST(step_CMP_abs_x_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xDD CMP ABS X (comparing a lesser value).
 */
TEST(step_CMP_abs_x_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xDD CMP ABS X (comparing a greater value).
 */
TEST(step_CMP_abs_x_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
