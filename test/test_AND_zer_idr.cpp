...
TEST(step_AND_zer_idr)
{
    ...
    /* at 0x1000, add an ADD instruction. */
    mem[0x1000] = 0x32;
    mem[0x1001] = 0x05;
    ...
    /* at 0x0810, the and input. */
    mem[0x0810] = EXPECTED_AND_INPUT;
...
/**
 * 0x32 AND ZER IDR zero flag.
 */
TEST(step_AND_zer_idr_zero_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_AND_INPUT = 0x12;
...
/**
 * 0x32 AND ZER IDR negative flag.
 */
TEST(step_AND_zer_idr_negative_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
