...
/**
 * 0xAD LDA abs normal result (not negative or zero).
 */
TEST(step_LDA_abs_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xAD LDA abs Zero result.
 */
TEST(step_LDA_abs_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xAD LDA abs, the negative flag is set.
 */
TEST(step_LDA_abs_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
