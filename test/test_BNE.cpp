...
/**
 * 0xD0 BNE branch not taken.
 */
TEST(step_BNE_no_branch)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BNE instruction. */
    mem[0x1000] = 0xD0;
    mem[0x1001] = 5;
...
/**
 * 0xD0 BNE branch taken, positive jump.
 */
TEST(step_BNE_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xD0 BNE branch taken, negative jump.
 */
TEST(step_BNE_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
