...
/**
 * 0x86 STX zer instruction.
 */
TEST(step_STA_zer_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* POSTCONDITION: A is stored in mem[0x0005]. */
    TEST_EXPECT(EXPECTED_X_VALUE == mem[0x0005]);
