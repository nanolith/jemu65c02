...
/**
 * 0x70 BVS branch not taken.
 */
TEST(step_BVS_no_branch)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BVS instruction. */
    mem[0x1000] = 0x70;
    mem[0x1001] = 5;
...
/**
 * 0x70 BVS branch taken, positive jump.
 */
TEST(step_BVS_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x70 BVS branch taken, negative jump.
 */
TEST(step_BVS_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
