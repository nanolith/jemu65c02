...
/**
 * 0xE5 SBC zer binary subtract without carry.
 */
TEST(step_SBC_zer_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, add the input. */
    mem[0x0005] = EXPECTED_SUB_INPUT;
...
/**
 * 0xE5 SBC zer binary subtract with borrow input.
 */
TEST(step_SBC_zer_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE5 SBC zer binary subtract causes borrow.
 */
TEST(step_SBC_zer_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE5 SBC zer binary subtract causes zero flag.
 */
TEST(step_SBC_zer_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xE5 SBC zer decimal subtract without carry.
 */
TEST(step_SBC_zer_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xE5 SBC zer decimal subtract with borrow input.
 */
TEST(step_SBC_zer_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xE5 SBC zer decimal subtract causes borrow.
 */
TEST(step_SBC_zer_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xE5 SBC zer decimal subtract causes zero flag.
 */
TEST(step_SBC_zer_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
