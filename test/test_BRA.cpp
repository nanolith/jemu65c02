...
/**
 * 0x80 BRA branch taken, positive jump.
 */
TEST(step_BRA_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BRA instruction. */
    mem[0x1000] = 0x80;
    mem[0x1001] = 5;
...
/**
 * 0x80 BRA branch taken, negative jump.
 */
TEST(step_BRA_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
