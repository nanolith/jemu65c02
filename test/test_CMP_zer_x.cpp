...
/**
 * 0xD5 CMP ZER X (comparing two equal values).
 */
TEST(step_CMP_zer_x_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0025, set the CMP input. */
    mem[0x0025] = EXPECTED_CMP_INPUT;
...
/**
 * 0xD5 CMP ZER X (comparing a lesser value).
 */
TEST(step_CMP_zer_x_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xD5 CMP ZER X (comparing a greater value).
 */
TEST(step_CMP_zer_x_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
