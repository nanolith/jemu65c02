...
TEST_SUITE(j65c02_SBC_zer_y_idr);
...
/**
 * 0xF1 SBC zer y idr binary subtract without carry.
 */
TEST(step_SBC_zer_y_idr_binary_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xF1 SBC zer y idr binary subtract with borrow input.
 */
TEST(step_SBC_zer_y_idr_binary_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF1 SBC zer y idr binary subtract causes borrow.
 */
TEST(step_SBC_zer_y_idr_binary_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF1 SBC zer y idr binary subtract causes zero flag.
 */
TEST(step_SBC_zer_y_idr_binary_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
...
/**
 * 0xF1 SBC zer y idr decimal subtract without carry.
 */
TEST(step_SBC_zer_y_idr_decimal_subtract_no_carry)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xF1 SBC zer y idr decimal subtract with borrow input.
 */
TEST(step_SBC_zer_y_idr_decimal_subtract_with_borrow_input)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xF1 SBC zer y idr decimal subtract causes borrow.
 */
TEST(step_SBC_zer_y_idr_decimal_subtract_causes_borrow)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x01;
...
/**
 * 0xF1 SBC zer y idr decimal subtract causes zero flag.
 */
TEST(step_SBC_zer_y_idr_decimal_subtract_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    const uint8_t EXPECTED_SUB_INPUT = 0x05;
