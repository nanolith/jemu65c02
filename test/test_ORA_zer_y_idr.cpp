...
TEST_SUITE(j65c02_ORA_zer_y_idr);
...
/**
 * 0x11 ORA ZER Y IDR normal (non-zero / non-negative).
 */
TEST(step_ORA_zer_y_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x11 ORA ZER Y IDR zero.
 */
TEST(step_ORA_zer_y_idr_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x11 ORA ZER Y IDR negative.
 */
TEST(step_ORA_zer_y_idr_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
