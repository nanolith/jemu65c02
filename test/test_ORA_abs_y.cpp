...
/**
 * 0x19 ORA ABS Y normal (non-zero / non-negative).
 */
TEST(step_ORA_abs_y_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x19 ORA ABS Y negative.
 */
TEST(step_ORA_abs_y_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
