...
/**
 * 0xC0 CPY IMM (comparing two equal values).
 */
TEST(step_CPY_imm_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xC0 CPY IMM (comparing a lesser value).
 */
TEST(step_CPY_imm_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xC0 CPY IMM (comparing a greater value).
 */
TEST(step_CPY_imm_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
