...
TEST_SUITE(j65c02_STA_zer_y_idr);
...
/**
 * 0x91 STA zer y idr instruction.
 */
TEST(step_STA_zer_y_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* POSTCONDITION: A is stored in mem[0x2005]. */
    TEST_EXPECT(EXPECTED_A_VALUE == mem[0x2005]);
