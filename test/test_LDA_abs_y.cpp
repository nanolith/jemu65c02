...
/**
 * 0xB9 LDA abs y normal result (not negative or zero).
 */
TEST(step_LDA_abs_y_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xB9 LDA abs y Zero result.
 */
TEST(step_LDA_abs_y_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xB9 LDA abs y, the negative flag is set.
 */
TEST(step_LDA_abs_y_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
