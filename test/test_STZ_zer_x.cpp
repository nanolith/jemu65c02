...
/**
 * 0x74 STZ zer x instruction.
 */
TEST(step_STZ_zer_x_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x000A, make the value non-zero. */
    mem[0x000A] = 0xFF;
    ...
    /* PRECONDITION: set X to the 0x05. */
    ...
    /* POSTCONDITION: 0 is stored in mem[0x000A]. */
    TEST_EXPECT(0 == mem[0x000A]);
