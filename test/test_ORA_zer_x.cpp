...
/**
 * 0x15 ORA ZER X normal (non-zero / non-negative).
 */
TEST(step_ORA_zer_x_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x00A, add the ORA input. */
    mem[0x000A] = EXPECTED_ORA_INPUT;
...
/**
 * 0x15 ORA ZER X negative.
 */
TEST(step_ORA_zer_x_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
