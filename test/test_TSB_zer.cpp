...
/**
 * 0x04 TSB zer instruction normal operation.
 */
TEST(step_TSB_zer)
{
    j65c02* inst = nullptr;
    ...
    const uint8_t EXPECTED_INPUT = 0x7F;
    const uint8_t EXPECTED_OUTPUT = 0xFF;
    ...
    /* POSTCONDITION: mem[0x0005] is EXPECTED_OUTPUT. */
