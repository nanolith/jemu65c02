...
/**
 * 0xC4 CPY ZER (comparing two equal values).
 */
TEST(step_CPY_zer_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, add the CPY input. */
    mem[0x0005] = EXPECTED_CPY_INPUT;
...
/**
 * 0xC4 CPY ZER (comparing a lesser value).
 */
TEST(step_CPY_zer_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xC4 CPY ZER (comparing a greater value).
 */
TEST(step_CPY_zer_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
