...
/**
 * 0x0E ASL ABS sets the carry bit if the high bit is shifted out.
 */
TEST(step_ASL_abs_carry_flag)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x0E ASL ABS sets the negative bit if the high bit is set after shifting.
 */
TEST(step_ASL_abs_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x0E ASL ABS sets the zero flag if the result is zero.
 */
