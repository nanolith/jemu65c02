...
/**
 * 0x9C STZ abs instruction.
 */
TEST(step_STZ_abs_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* set 0x2000 to some value other than 0. */
    mem[0x2000] = 0xFF;
    ...
    /* POSTCONDITION: mem[0x2000] is set to 0. */
    TEST_EXPECT(0 == mem[0x2000]);
