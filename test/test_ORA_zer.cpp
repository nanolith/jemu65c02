...
/**
 * 0x05 ORA ZER normal (non-zero / non-negative).
 */
TEST(step_ORA_zer_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x005, add the ORA input. */
    mem[0x0005] = EXPECTED_ORA_INPUT;
...
/**
 * 0x05 ORA ZER negative.
 */
TEST(step_ORA_zer_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
