...
/**
 * 0xA2 LDX imm normal result (not negative or zero).
 */
TEST(step_LDX_imm_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xA2 LDX imm Zero result.
 */
TEST(step_LDX_imm_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xA2 LDX imm, the negative flag is set.
 */
TEST(step_LDX_imm_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
