...
/**
 * 0xBD LDA abs x normal result (not negative or zero).
 */
TEST(step_LDA_abs_x_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xBD LDA abs x Zero result.
 */
TEST(step_LDA_abs_x_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xBD LDA abs x, the negative flag is set.
 */
TEST(step_LDA_abs_x_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
