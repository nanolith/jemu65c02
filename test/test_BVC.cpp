...
/**
 * 0x50 BVC branch not taken.
 */
TEST(step_BVC_no_branch)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a BVC instruction. */
    mem[0x1000] = 0x50;
    mem[0x1001] = 5;
...
/**
 * 0x50 BVC branch taken, positive jump.
 */
TEST(step_BVC_branch_positive)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x50 BVC branch taken, negative jump.
 */
TEST(step_BVC_branch_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
