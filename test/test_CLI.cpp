...
/**
 * 0x58 CLI instruction.
 */
TEST(step_CLI_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x1000, add a CLI instruction. */
    mem[0x1000] = 0x58;
    ...
    /* PRECONDITION: set the interrupt disable flag. */
    ...
    /* POSTCONDITION: the interrupt disable flag is clear. */
