...
TEST_SUITE(j65c02_CMP_zer_y_idr);
...
/**
 * 0xD1 CMP ZER Y IDR (comparing two equal values).
 */
TEST(step_CMP_zer_y_idr_equal)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0020, set the address. */
    mem[0x0020] = 0x00;
    mem[0x0021] = 0x20;

    /* at 0x2006, set the CMP input. */
    mem[0x2006] = EXPECTED_CMP_INPUT;
...
/**
 * 0xD1 CMP ZER Y IDR (comparing a lesser value).
 */
TEST(step_CMP_zer_y_idr_lesser)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0xD1 CMP ZER Y IDR (comparing a greater value).
 */
TEST(step_CMP_zer_y_idr_greater)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
