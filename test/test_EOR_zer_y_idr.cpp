...
TEST_SUITE(j65c02_EOR_zer_y_idr);
...
/**
 * 0x51 EOR zer y idr normal result (not negative or zero).
 */
TEST(step_EOR_zer_y_idr_basics)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, set the address for the input. */
    mem[0x0005] = 0x00;
    mem[0x0006] = 0x20;
...
/**
 * 0x51 EOR zer y idr Zero result.
 */
TEST(step_EOR_zer_y_idr_zero)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
...
/**
 * 0x51 EOR zer y idr, the negative flag is set.
 */
TEST(step_EOR_zer_y_idr_negative)
{
    j65c02* inst = nullptr;
    uint8_t mem[65536];
    ...
    /* at 0x0005, set the address of the input. */
    mem[0x0005] = 0x00;
    mem[0x0006] = 0x20;
